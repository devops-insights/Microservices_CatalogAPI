(function() {
    ...
    var utils = require('../fvt/utils.js');
    ...
    */ 
    ...
    describe('API', function() {
        this.timeout(20000);
        it('list all items in DB', function(done) {
        ...
        it('add an item to DB', function(done) {
        ...
        it('update the item with specific id', function(done) {
            utils.getItems('Test Table', function(err, data) {
                if(err) {
                    assert.fail("Failed to get items using name");
                    done();
        ...
        it('delete an item with specific id', function(done) {
            utils.getItems('Test Table', function(err, data) {
                if(err) {
                    assert.fail("Failed to get items using name");
                    done();
